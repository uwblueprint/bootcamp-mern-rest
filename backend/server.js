...
/* line 21 ensures that the JSON body of any request can be accessed by through req.body */
/* line 22 configures requests to the /api/restaurants path to be handled by the restaurantRouter */
